...
## プロジェクトのダウンロード
[本ハンズオンで使用するプロジェクトはこちらでダウンロードできます](https://github.com/EsriJapan/workshops/raw/master/20190823_app-development-hands-on/HandsOn_Data.zip)
...
- @renderable
  - このデコレーターで定義されたプロパティが変更されるたびに描画が更新されます。
